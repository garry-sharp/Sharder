...
$(
    ...
    shasum $build_dir/$app_name-$version-windows-amd64.exe >> $build_dir/$app_name-$version-windows-amd64.exe.sha256
    # macOS (x86_64)
    ...
    shasum $build_dir/$app_name-$version-windows-arm64.exe >> $build_dir/$app_name-$version-windows-arm64.exe.sha256
    # macOS (ARM64)
